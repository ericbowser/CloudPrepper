...
const ThemeToggle = () => {
    ...
    return (
        <button
            onClick={toggleTheme}
            className="relative inline-flex h-8 w-14 items-center justify-center rounded-full 
      ...
      >
        {isDark ? (
            ...
            <svg className="h-6 w-6 p-1 text-gray-700" fill="currentColor" viewBox="0 0 20 20">
