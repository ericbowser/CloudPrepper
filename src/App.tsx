                ...
                {activeSection === 'quiz' && currentQuizQuestions.length > 0 && (
                    <>
                        ...
                        {timerEnabled && timerDuration > 0 && (
                            <div
                                className="flex items-center space-x-2 bg-white dark:bg-dark-700 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-600 mr-4">
                                <svg
                        ...
                        {/* Question Stats */}
                        <div
                            className="flex items-center space-x-4 bg-white dark:bg-dark-700 px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-600 mr-4">
